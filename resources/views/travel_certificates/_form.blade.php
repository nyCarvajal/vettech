...
>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <textarea name="clinical_notes" class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-200 min-h-[120px]" placeholder="Notas">{{ old('clinical_notes', $certificate->clinical_notes ?? '') }}</textarea>
        </div>
        <div class="mt-4">
            <label class="text-xs uppercase tracking-wide text-slate-500 font-semibold">Declaración</label>
            <textarea name="declaration_text" class="mt-2 w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-200 min-h-[140px]" rows="4">{{ old('declaration_text', $declaration ?? '') }}</textarea>
        </div>
    </div>
</div>
