    ...
    <form method="post" action="{{ $immunization->exists ? route('patients.immunizations.update', [$patient, $immunization]) : route('patients.immunizations.store', $patient) }}" class="space-y-4 p-6 rounded-2xl bg-white shadow" novalidate>
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="date" name="applied_at" value="{{ old('applied_at', optional($immunization->applied_at)->toDateString()) }}" class="w-full rounded-xl border border-slate-200">
            ...
            <div>
                ...
                <input type="date" name="next_due_at" value="{{ old('next_due_at', optional($immunization->next_due_at)->toDateString()) }}" class="w-full rounded-xl border border-slate-200">
            ...
            <div>
                ...
                <input type="date" name="expires_at" value="{{ old('expires_at', optional($immunization->expires_at)->toDateString()) }}" class="w-full rounded-xl border border-slate-200">
                @error('expires_at')<p class="text-rose-600 text-sm">{{ $message }}</p>@enderror
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="vaccine_name" value="{{ old('vaccine_name', $immunization->vaccine_name) }}" placeholder="Rabia, Moquillo..." class="w-full rounded-xl border border-slate-200">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="item_manual" value="{{ old('item_manual', $immunization->item_manual) }}" placeholder="Nombre comercial" class="w-full rounded-xl border border-slate-200">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="batch_lot" value="{{ old('batch_lot', $immunization->batch_lot) }}" class="w-full rounded-xl border border-slate-200" required>
            ...
            <div>
                ...
                <input type="text" name="dose" value="{{ old('dose', $immunization->dose) }}" class="w-full rounded-xl border border-slate-200">
        ...
        <div>
            ...
            <textarea name="notes" rows="3" class="w-full rounded-xl border border-slate-200">{{ old('notes', $immunization->notes) }}</textarea>
        </div>
