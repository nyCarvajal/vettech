...
class StoreTravelCertificateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'origin_department_id' => ['required_if:type,national_co', 'nullable', 'exists:tenant.departamentos,id'],
            'origin_municipality_id' => ['required_if:type,national_co', 'nullable', 'exists:tenant.municipios,id'],
            'destination_department_id' => ['required_if:type,national_co', 'nullable', 'exists:tenant.departamentos,id'],
            'destination_municipality_id' => ['required_if:type,national_co', 'nullable', 'exists:tenant.municipios,id'],
